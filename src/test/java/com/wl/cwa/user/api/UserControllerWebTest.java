...
import com.wl.cwa.user.application.UserAdministrationService;
...
@Import({SecurityConfig.class, SharedConfig.class, ProblemDetailFactory.class, GlobalExceptionHandler.class, com.wl.cwa.shared.api.PageRequestFactory.class})
...
class UserControllerWebTest {
    ...
    void listWithReadPermissionReturnsPageShape() throws Exception {
        when(userService.list(any(), any(), any(), any()))
                .thenReturn(new PageResponse<>(
                        List.of(new com.wl.cwa.user.api.dto.UserSummary(
    ...
    void patchWithStaleVersionReturns409FromService() throws Exception {
        when(userService.update(any()))
                .thenThrow(new com.wl.cwa.shared.error.BusinessException(
                        com.wl.cwa.shared.error.ErrorCode.VERSION_CONFLICT, "version mismatch", null, List.of()));
