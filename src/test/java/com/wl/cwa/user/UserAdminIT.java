...
class UserAdminIT extends ContainerTestSupport {
    ...
    private String login(String username, String password, String remoteAddr) throws Exception {
        MvcResult result = mockMvc.perform(post("/api/v1/login")
                ...
                .andReturn();
        return com.wl.cwa.support.JsonText.extractString(result.getResponse().getContentAsString(), "token");
    }
    ...
    private String createViaApi(String token, String username) throws Exception {
        ...
        return com.wl.cwa.support.JsonText.extractString(body, "publicId");
    }
    ...
    void createListDetailPatchRolesDisableLifecycle() throws Exception {
        ...
        MvcResult created = mockMvc
                ...
                .andReturn();
        String publicId = com.wl.cwa.support.JsonText.extractString(created.getResponse().getContentAsString(), "publicId");
        ...
        MvcResult detailResult = mockMvc
                ...
                .andExpect(status().isOk())
                .andReturn();
        int version = com.wl.cwa.support.JsonText.extractInt(detailResult.getResponse().getContentAsString(), "version");
        ...
        int versionAfterRoles =
                com.wl.cwa.support.JsonText.extractInt(rolesResult.getResponse().getContentAsString(), "version");
        mockMvc.perform(get("/api/v1/me").header("Authorization", "Bearer " + targetToken))
