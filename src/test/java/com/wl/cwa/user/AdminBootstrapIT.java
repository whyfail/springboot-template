...
import com.wl.cwa.user.application.AdminBootstrap;
...
/**
 * Boots the full context with {@code cwa.bootstrap.enabled=true} so the ApplicationRunner executes
...
@SpringBootTest(
        properties = {
            "cwa.bootstrap.enabled=true",
            "cwa.bootstrap.username=bootstrap-admin",
            "cwa.bootstrap.password=Bootstrap-Pass-2026!",
            "cwa.bootstrap.display-name=Bootstrap Admin"
        })
