...
@Import({SecurityConfig.class, SharedConfig.class, ProblemDetailFactory.class, GlobalExceptionHandler.class, com.example.app.shared.api.PageRequestFactory.class})
...
class UserControllerWebTest {
    ...
    void listWithReadPermissionReturnsPageShape() throws Exception {
        when(userService.list(any(), any(), any(), any()))
                .thenReturn(new PageResponse<>(
                        List.of(new com.example.app.user.api.dto.UserSummary(
    ...
    void patchWithStaleVersionReturns409FromService() throws Exception {
        when(userService.update(any()))
                .thenThrow(new com.example.app.shared.error.BusinessException(
                        com.example.app.shared.error.ErrorCode.VERSION_CONFLICT, "version mismatch", null, List.of()));
