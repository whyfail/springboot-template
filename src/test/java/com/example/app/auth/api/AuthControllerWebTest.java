...
import com.example.app.auth.infrastructure.security.SecurityConfig;
import com.example.app.shared.config.SecurityProperties;
import com.example.app.shared.config.SharedConfig;
import com.example.app.shared.error.GlobalExceptionHandler;
...
class AuthControllerWebTest {
    ...
    @Test
    void loginReturnsTopLevelToken() throws Exception {
        Instant expiresAt = Instant.parse("2026-09-19T06:00:00Z");
        when(authService.login(any(), any()))
                .thenReturn(new com.example.app.auth.api.dto.LoginResponse(
                        "opaque-token-value",
                        "Bearer",
                        expiresAt,
                        new com.example.app.auth.api.dto.CurrentUserResponse(
                                UUID.fromString("00000000-0000-0000-0000-000000000042"),
                                "admin",
                                "Administrator",
                                null,
        ...
        mockMvc.perform(post("/api/v1/login")
                        ...
                        .content("{\"username\":\"admin\",\"password\":\"ChangeMe123!\",\"remember\":true}"))
    ...
    @Test
    void loginWithoutUsernameFails() throws Exception {
        mockMvc.perform(post("/api/v1/login")
                        .contentType(MediaType.APPLICATION_JSON)
                ...
                .andExpect(jsonPath("$.errors[0].message").value("用户名必填"));
    }
    ...
    void logoutWithoutTokenReturns401() throws Exception {
        org.mockito.Mockito.doThrow(new com.example.app.shared.error.BusinessException(
                        com.example.app.shared.error.ErrorCode.AUTH_REQUIRED))
                .when(authService)
                .logout(null, null);
    ...
    void meWithSessionPrincipalReturnsCurrentUserShape() throws Exception {
        when(authService.currentUser(any()))
                .thenReturn(new com.example.app.auth.api.dto.CurrentUserResponse(
                        UUID.fromString("00000000-0000-0000-0000-000000000042"),
                        "admin",
                        "Administrator",
                        null,
