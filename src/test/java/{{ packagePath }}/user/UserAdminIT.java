...
class UserAdminIT extends ContainerTestSupport {
    ...
    private String login(String username, String password, String remoteAddr) throws Exception {
        MvcResult result = mockMvc.perform(post("/api/v1/login")
                ...
                .andReturn();
        return {{ package }}.support.JsonText.extractString(result.getResponse().getContentAsString(), "token");
    }
    ...
    private String createViaApi(String token, String username) throws Exception {
        ...
        return {{ package }}.support.JsonText.extractString(body, "publicId");
    }
    ...
    void createListDetailPatchRolesDisableLifecycle() throws Exception {
        ...
        MvcResult created = mockMvc
                ...
                .andReturn();
        String publicId = {{ package }}.support.JsonText.extractString(created.getResponse().getContentAsString(), "publicId");
        ...
        MvcResult detailResult = mockMvc
                ...
                .andExpect(status().isOk())
                .andReturn();
        int version = {{ package }}.support.JsonText.extractInt(detailResult.getResponse().getContentAsString(), "version");
        ...
        int versionAfterRoles =
                {{ package }}.support.JsonText.extractInt(rolesResult.getResponse().getContentAsString(), "version");
        mockMvc.perform(get("/api/v1/me").header("Authorization", "Bearer " + targetToken))
