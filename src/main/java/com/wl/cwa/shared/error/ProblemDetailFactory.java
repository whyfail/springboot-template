...
/**
 * Builds Problem Details bodies carrying the CWA extensions {@code code}, {@code msg} and
...
public class ProblemDetailFactory {
    ...
    public ProblemDetailFactory(CwaSecurityProperties properties, Clock clock) {
