package com.wl.cwa.auth.infrastructure.security;
...
public class SecurityConfig {
    ...
    @Bean
    public PasswordEncoder passwordEncoder(CwaSecurityProperties properties) {
    ...
    @Bean
    public CorsConfigurationSource corsConfigurationSource(CwaSecurityProperties properties) {
