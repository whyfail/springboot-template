...
import {{ package }}.shared.api.PageRequestFactory;
import {{ package }}.shared.api.PageResponse;
import {{ package }}.shared.security.AuthenticatedUser;
import {{ package }}.user.api.dto.CreateUserRequest;
import {{ package }}.user.api.dto.ReplaceRolesRequest;
import {{ package }}.user.api.dto.SetEnabledRequest;
import {{ package }}.user.api.dto.UpdateUserRequest;
import {{ package }}.user.api.dto.UserDetail;
import {{ package }}.user.api.dto.UserListQuery;
import {{ package }}.user.api.dto.UserSummary;
import {{ package }}.user.application.UserAdministrationService;
import {{ package }}.user.application.command.CreateUserCommand;
import {{ package }}.user.application.command.ReplaceRolesCommand;
import {{ package }}.user.application.command.SetEnabledCommand;
import {{ package }}.user.application.command.UpdateUserCommand;
